...
void TrajectoryController::InitializeParameters() {
...
void TrajectoryController::CalculateRotorVelocities(Eigen::VectorXd* rotor_velocities) const {
...
void TrajectoryController::SetOdometry(const EigenOdometry& odometry) {
  odometry_ = odometry;
}

void TrajectoryController::SetTrajectoryPoint(
    const EigenTrajectoryPoint& command_trajectory) {
  command_trajectory_ = command_trajectory;
  controller_active_ = true;
}

void TrajectoryController::ComputeDesiredAcceleration(Eigen::Vector3d* acceleration) const {
  assert(acceleration);
...
void TrajectoryController::ComputeDesiredAngularAcc(const Eigen::Vector3d& acceleration,
  ...
  // TODO include angular rate references at some point.
